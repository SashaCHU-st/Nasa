    ...
    <div className="default-container">
      ...
      <div className="default-message">
        ...
        <li><strong>When NOT logged in:</strong></li>
          <li><strong>User List:</strong> Shows all registered users, their information, and how many favorite articles they like (will be updated).</li>
          <li><strong>P.S. </strong> Sometimes it might take some time to Database to connect, wait a bit and update page ⌛️</li>
          <li><strong>Login/Signup:</strong> You can log in with <strong>username: Wapice, password: 12345678</strong>, OR create a new account.</li>
          <li><strong>When logged in:</strong></li>
          <ul>
            <li><strong>Search:</strong> Search something about space, e.g., moon, mars, etc.</li>
